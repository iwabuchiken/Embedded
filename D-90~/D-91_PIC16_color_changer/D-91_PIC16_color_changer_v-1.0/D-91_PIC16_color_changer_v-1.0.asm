...
$004B	$2861			GOTO	L__Opearations_1
...
$0050	$2854			GOTO	L__Opearations_2
...
$0060	$	L__Opearations_3:
;D-91_PIC16_color_changer_v-1.0.c,60 :: 		}
$0060	$2845			GOTO	L__Opearations_0
...
$0022	$0009			RETFIE
$0062	$	GlobalIniD-91_PIC16_color_changer_v-1:
$0062	$3001			MOVLW	1
$0063	$1303			BCF	STATUS, RP1
$0064	$1283			BCF	STATUS, RP0
$0065	$008C			MOVWF	_LED_FLAG+0
$0066	$3008			MOVLW	8
$0067	$008D			MOVWF	_bit_len+0
$0068	$0008			RETURN
$0023	$	_main:
...
;D-91_PIC16_color_changer_v-1.0.c,125 :: 		}//while(1)
$0043	$2841			GOTO	L_main_6
;D-91_PIC16_color_changer_v-1.0.c,127 :: 		}//void main(void)
$0044	$2844			GOTO	$
