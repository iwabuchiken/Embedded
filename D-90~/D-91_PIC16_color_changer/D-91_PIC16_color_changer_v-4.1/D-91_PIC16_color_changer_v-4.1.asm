...
$00E5	$3001			MOVLW	1
$00E6	$009A			MOVWF	FARG__pulse+0
$00E7	$3000			MOVLW	0
$00E8	$009B			MOVWF	FARG__pulse+1
$00E9	$2031			CALL	__pulse
...
$00FA	$3002			MOVLW	2
$00FB	$009A			MOVWF	FARG__pulse+0
$00FC	$3000			MOVLW	0
$00FD	$009B			MOVWF	FARG__pulse+1
$00FE	$2031			CALL	__pulse
...
$0128	$0008			RETURN
$0069	$	__read_Reader:
;D-91_PIC16_color_changer_v-4.1.c,380 :: 		_read_Reader() {
;D-91_PIC16_color_changer_v-4.1.c,387 :: 		RESET_TMR;
$0069	$1303			BCF	STATUS, RP1
$006A	$1283			BCF	STATUS, RP0
$006B	$0181			CLRF	TMR0, 1
;D-91_PIC16_color_changer_v-4.1.c,397 :: 		_while_PORTB_0x01(0);
$006C	$0196			CLRF	FARG__while_PORTB_0x01+0
$006D	$0197			CLRF	FARG__while_PORTB_0x01+1
$006E	$2149			CALL	__while_PORTB_0x01
;D-91_PIC16_color_changer_v-4.1.c,408 :: 		result = _judge_TMR_(156, 196);
$006F	$309C			MOVLW	156
...
;D-91_PIC16_color_changer_v-4.1.c,444 :: 		if (result == false) {
$0094	$0840			MOVF	STACK_0, 0
$0095	$3A00			XORLW	0
$0096	$1D03			BTFSS	STATUS, Z
$0097	$289B			GOTO	L__read_Reader_33
;D-91_PIC16_color_changer_v-4.1.c,448 :: 		return false;
$0098	$01C0			CLRF	STACK_0
$0099	$01C1			CLRF	STACK_0+1
$009A	$0008			RETURN
;D-91_PIC16_color_changer_v-4.1.c,450 :: 		}
$009B	$	L__read_Reader_33:
;D-91_PIC16_color_changer_v-4.1.c,457 :: 		return true;
$009B	$3001			MOVLW	1
$009C	$00C0			MOVWF	STACK_0
$009D	$3000			MOVLW	0
$009E	$00C1			MOVWF	STACK_0+1
;D-91_PIC16_color_changer_v-4.1.c,459 :: 		}//_read_Reader
$009F	$0008			RETURN
$00A0	$	__pulse_500u:
...
$0165	$0096			MOVWF	FARG__pulse_u_100+0
$0166	$3000			MOVLW	0
$0167	$0097			MOVWF	FARG__pulse_u_100+1
...
;D-91_PIC16_color_changer_v-4.1.c,302 :: 		PORTA = 0x00;
$0015	$0185			CLRF	PORTA, 1
;D-91_PIC16_color_changer_v-4.1.c,309 :: 		result = _read_Reader();
$0016	$2069			CALL	__read_Reader
$0017	$0840			MOVF	STACK_0, 0
$0018	$008C			MOVWF	_result
;D-91_PIC16_color_changer_v-4.1.c,316 :: 		if (result == false) {
$0019	$0840			MOVF	STACK_0, 0
$001A	$3A00			XORLW	0
$001B	$1D03			BTFSS	STATUS, Z
$001C	$2823			GOTO	L_interrupt_29
;D-91_PIC16_color_changer_v-4.1.c,318 :: 		_pulse_500u(3);
$001D	$3003			MOVLW	3
$001E	$0092			MOVWF	FARG__pulse_500u+0
$001F	$3000			MOVLW	0
$0020	$0093			MOVWF	FARG__pulse_500u+1
$0021	$20A0			CALL	__pulse_500u
;D-91_PIC16_color_changer_v-4.1.c,320 :: 		return;
$0022	$2826			GOTO	L_Interrupt_end
;D-91_PIC16_color_changer_v-4.1.c,322 :: 		}
$0023	$	L_interrupt_29:
;D-91_PIC16_color_changer_v-4.1.c,329 :: 		_response();
$0023	$2162			CALL	__response
;D-91_PIC16_color_changer_v-4.1.c,337 :: 		INTCON |= 0x10;        // INT interrupt => permitted
$0024	$160B			BSF	INTCON, 4
;D-91_PIC16_color_changer_v-4.1.c,338 :: 		INTCON |= 0x80;
$0025	$178B			BSF	INTCON, 7
;D-91_PIC16_color_changer_v-4.1.c,340 :: 		}//void interrupt(void)
...
$0170	$0008			RETURN
$0129	$	_main:
;D-91_PIC16_color_changer_v-4.1.c,343 :: 		void main(void)
;D-91_PIC16_color_changer_v-4.1.c,347 :: 		TRISA     = 0x00;
$0129	$1303			BCF	STATUS, RP1
$012A	$1683			BSF	STATUS, RP0
$012B	$0185			CLRF	TRISA, 1
;D-91_PIC16_color_changer_v-4.1.c,348 :: 		PORTA     = 0x00;		//0000 0010
$012C	$1283			BCF	STATUS, RP0
$012D	$0185			CLRF	PORTA, 1
;D-91_PIC16_color_changer_v-4.1.c,350 :: 		TRISB     = 0xFF;		// Input: RB0 ~ RB7
$012E	$30FF			MOVLW	255
$012F	$1683			BSF	STATUS, RP0
$0130	$0086			MOVWF	TRISB
;D-91_PIC16_color_changer_v-4.1.c,352 :: 		OPTION_REG &= 0x7F;	// Pull-up => on
$0131	$307F			MOVLW	127
$0132	$0501			ANDWF	OPTION_REG, 0
$0133	$00C0			MOVWF	STACK_0
$0134	$0840			MOVF	STACK_0, 0
$0135	$0081			MOVWF	OPTION_REG
;D-91_PIC16_color_changer_v-4.1.c,353 :: 		OPTION_REG &= 0xFF;	// INT interrupt => by 0V ~> 5V
$0136	$30FF			MOVLW	255
$0137	$05C0			ANDWF	STACK_0, 1
$0138	$0840			MOVF	STACK_0, 0
$0139	$0081			MOVWF	OPTION_REG
;D-91_PIC16_color_changer_v-4.1.c,356 :: 		OPTION_REG &= 0xDF;	// Timer by clock
$013A	$30DF			MOVLW	223
$013B	$05C0			ANDWF	STACK_0, 1
$013C	$0840			MOVF	STACK_0, 0
$013D	$0081			MOVWF	OPTION_REG
;D-91_PIC16_color_changer_v-4.1.c,357 :: 		OPTION_REG &= 0xF0;	// Prescaler => on
$013E	$30F0			MOVLW	240
$013F	$05C0			ANDWF	STACK_0, 1
$0140	$0840			MOVF	STACK_0, 0
$0141	$0081			MOVWF	OPTION_REG
;D-91_PIC16_color_changer_v-4.1.c,358 :: 		OPTION_REG |= 0x07; // Prescaler => 1/256
$0142	$3007			MOVLW	7
$0143	$0440			IORWF	STACK_0, 0
$0144	$0081			MOVWF	OPTION_REG
;D-91_PIC16_color_changer_v-4.1.c,366 :: 		INTCON |= 0x10;        // INT interrupt => permitted
$0145	$160B			BSF	INTCON, 4
;D-91_PIC16_color_changer_v-4.1.c,367 :: 		INTCON |= 0x80;
$0146	$178B			BSF	INTCON, 7
;D-91_PIC16_color_changer_v-4.1.c,369 :: 		while(1)
$0147	$	L_main_30:
$0147	$2947			GOTO	L_main_30
;D-91_PIC16_color_changer_v-4.1.c,377 :: 		}//void main(void)
$0148	$2948			GOTO	$
