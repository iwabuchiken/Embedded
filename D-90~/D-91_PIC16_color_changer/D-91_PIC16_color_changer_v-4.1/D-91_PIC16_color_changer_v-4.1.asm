...
$0128	$0008			RETURN
$0069	$	__read_Reader:
;D-91_PIC16_color_changer_v-4.1.c,379 :: 		_read_Reader() {
;D-91_PIC16_color_changer_v-4.1.c,386 :: 		RESET_TMR;
$0069	$1303			BCF	STATUS, RP1
$006A	$1283			BCF	STATUS, RP0
$006B	$0181			CLRF	TMR0, 1
;D-91_PIC16_color_changer_v-4.1.c,396 :: 		_while_PORTB_0x01(0);
$006C	$0196			CLRF	FARG__while_PORTB_0x01+0
$006D	$0197			CLRF	FARG__while_PORTB_0x01+1
$006E	$2149			CALL	__while_PORTB_0x01
;D-91_PIC16_color_changer_v-4.1.c,407 :: 		result = _judge_TMR_(156, 196);
$006F	$309C			MOVLW	156
...
;D-91_PIC16_color_changer_v-4.1.c,443 :: 		if (result == false) {
$0094	$0840			MOVF	STACK_0, 0
$0095	$3A00			XORLW	0
$0096	$1D03			BTFSS	STATUS, Z
$0097	$289B			GOTO	L__read_Reader_33
;D-91_PIC16_color_changer_v-4.1.c,447 :: 		return false;
$0098	$01C0			CLRF	STACK_0
$0099	$01C1			CLRF	STACK_0+1
$009A	$0008			RETURN
;D-91_PIC16_color_changer_v-4.1.c,449 :: 		}
$009B	$	L__read_Reader_33:
;D-91_PIC16_color_changer_v-4.1.c,456 :: 		return true;
$009B	$3001			MOVLW	1
$009C	$00C0			MOVWF	STACK_0
$009D	$3000			MOVLW	0
$009E	$00C1			MOVWF	STACK_0+1
;D-91_PIC16_color_changer_v-4.1.c,458 :: 		}//_read_Reader
$009F	$0008			RETURN
$00A0	$	__pulse_500u:
...
;D-91_PIC16_color_changer_v-4.1.c,353 :: 		OPTION_REG &= 0xBF;	// INT interrupt => by 5V ~> 0V
$0136	$30BF			MOVLW	191
$0137	$05C0			ANDWF	STACK_0, 1
$0138	$0840			MOVF	STACK_0, 0
$0139	$0081			MOVWF	OPTION_REG
;D-91_PIC16_color_changer_v-4.1.c,355 :: 		OPTION_REG &= 0xDF;	// Timer by clock
$013A	$30DF			MOVLW	223
$013B	$05C0			ANDWF	STACK_0, 1
$013C	$0840			MOVF	STACK_0, 0
$013D	$0081			MOVWF	OPTION_REG
;D-91_PIC16_color_changer_v-4.1.c,356 :: 		OPTION_REG &= 0xF0;	// Prescaler => on
$013E	$30F0			MOVLW	240
$013F	$05C0			ANDWF	STACK_0, 1
$0140	$0840			MOVF	STACK_0, 0
$0141	$0081			MOVWF	OPTION_REG
;D-91_PIC16_color_changer_v-4.1.c,357 :: 		OPTION_REG |= 0x07; // Prescaler => 1/256
$0142	$3007			MOVLW	7
$0143	$0440			IORWF	STACK_0, 0
$0144	$0081			MOVWF	OPTION_REG
;D-91_PIC16_color_changer_v-4.1.c,365 :: 		INTCON |= 0x10;        // INT interrupt => permitted
$0145	$160B			BSF	INTCON, 4
;D-91_PIC16_color_changer_v-4.1.c,366 :: 		INTCON |= 0x80;
$0146	$178B			BSF	INTCON, 7
;D-91_PIC16_color_changer_v-4.1.c,368 :: 		while(1)
$0147	$	L_main_30:
$0147	$2947			GOTO	L_main_30
;D-91_PIC16_color_changer_v-4.1.c,376 :: 		}//void main(void)
$0148	$2948			GOTO	$
