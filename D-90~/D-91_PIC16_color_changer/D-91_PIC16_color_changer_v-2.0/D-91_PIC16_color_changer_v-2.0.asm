...
$000E	$	L_main_0:
;D-91_PIC16_color_changer_v-2.0.c,46 :: 		if (PORTB_0_H) {
$000E	$3001			MOVLW	1
...
;D-91_PIC16_color_changer_v-2.0.c,48 :: 		LED_1_ON;
$0014	$3001			MOVLW	1
$0015	$0085			MOVWF	PORTA
;D-91_PIC16_color_changer_v-2.0.c,50 :: 		} else {
$0016	$2819			GOTO	L_main_3
$0017	$	L_main_2:
;D-91_PIC16_color_changer_v-2.0.c,52 :: 		LED_2_ON;
$0017	$3002			MOVLW	2
$0018	$0085			MOVWF	PORTA
;D-91_PIC16_color_changer_v-2.0.c,54 :: 		}
$0019	$	L_main_3:
;D-91_PIC16_color_changer_v-2.0.c,56 :: 		}//while(1)
$0019	$280E			GOTO	L_main_0
;D-91_PIC16_color_changer_v-2.0.c,58 :: 		}//void main(void)
$001A	$281A			GOTO	$
